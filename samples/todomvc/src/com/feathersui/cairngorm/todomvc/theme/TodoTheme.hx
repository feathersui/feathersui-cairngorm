...
package com.feathersui.cairngorm.todomvc.theme;

import com.feathersui.cairngorm.todomvc.view.MainView;
import com.feathersui.cairngorm.todomvc.view.TodoItemRenderer;
...
class TodoTheme extends ClassVariantTheme {
	public function new() {
		...
		styleProvider.setStyleFunction(TextInput, MainView.CHILD_VARIANT_NEW_TODO_TEXT_INPUT, setNewTodoTextInputStyles);
		styleProvider.setStyleFunction(Label, null, setLabelStyles);
		styleProvider.setStyleFunction(Label, MainView.CHILD_VARIANT_TITLE_LABEL, setTitleLabelStyles);
		styleProvider.setStyleFunction(ToggleButton, MainView.CHILD_VARIANT_SELECT_ALL_TOGGLE, setSelectAllToggleButtonStyles);
		...
		styleProvider.setStyleFunction(LayoutGroup, MainView.CHILD_VARIANT_BOTTOM_BAR, setBottomBarStyles);
		styleProvider.setStyleFunction(Label, MainView.CHILD_VARIANT_FOOTER_TEXT, setFooterTextStyles);
